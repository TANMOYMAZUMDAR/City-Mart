...
import com.nbg.city_mart.databinding.ActivitySplashSreenBinding;
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                if(isFirstTime)
                {
                    ...
                    editor.apply();
                    Intent intent=new Intent(SplashSreen.this, com.nbg.city_mart.OnBoarding.class);
